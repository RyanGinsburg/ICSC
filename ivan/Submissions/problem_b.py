...
def cake_calculator(flour: int, sugar: int) -> list:
   ...
   flourNeeded = 100
   sugarNeeded = 50
   maxFlour = flour // flourNeeded
   maxSugar = sugar // sugarNeeded
   cakes = min(maxFlour, maxSugar)
   flourRemaining = flour - (flourNeeded * cakes)
   sugarRemaining = sugar - (sugarNeeded * cakes)
   return [cakes, flourRemaining, sugarRemaining]
